...
<!--        <div class="bg-dark-card rounded-xl p-4 border border-gray-700/50">-->
<!--            <p class="text-sm text-gray-400 mb-2">音频播放状态</p>-->
<!--            <div class="audio-visualizer" id="audioVisualizer">-->
<!--                <div class="audio-visualizer-bar" style="height: 30%; margin-right: 1px;"></div>-->
<!--                <div class="audio-visualizer-bar" style="height: 70%; margin-right: 1px;"></div>-->
<!--                <div class="audio-visualizer-bar" style="height: 50%; margin-right: 1px;"></div>-->
<!--                <div class="audio-visualizer-bar" style="height: 90%; margin-right: 1px;"></div>-->
<!--                <div class="audio-visualizer-bar" style="height: 60%;"></div>-->
<!--            </div>-->
<!--        </div>-->
    </div>
